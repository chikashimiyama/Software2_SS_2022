...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 489.0, 34.0, 92.0, 24.0 ],
					"text" : "auto rotate"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 75.0, 166.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"data" : 					{
						"clips" : [ 							{
								"absolutepath" : "Macintosh HD:/Users/chikashi/Works/Event/2022/Software2/K5/piano.wav",
								"filename" : "piano.wav",
								"filekind" : "audiofile",
								"id" : "u401011200",
								"loop" : 1,
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 233.0, 201.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"data" : 					{
						"clips" : [ 							{
								"absolutepath" : "Macintosh HD:/Users/chikashi/Works/Event/2022/Software2/K5/spoken.wav",
								"filename" : "spoken.wav",
								"filekind" : "audiofile",
								"id" : "u182011149",
								"loop" : 1,
...
,
					...
					"outlettype" : [ "signal", "signal", "signal", "", "dictionary" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 199.0, 162.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 130.0, 219.0, 68.0, 22.0 ],
					"text" : "selector~ 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 591.0, 71.0, 56.0, 22.0 ],
					"text" : "metro 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 591.0, 100.0, 72.0, 22.0 ],
					"text" : "counter 360"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 591.0, 136.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 591.0, 170.0, 82.0, 22.0 ],
					"text" : "aed 1 $1 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 528.0, 416.0, 185.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 530.0, 285.0, 176.5, 22.0 ],
					"saved_object_attributes" : 					{
						"active" : [ 1 ],
						"center_att_db" : 6.0,
						"center_curve" : 0.2,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal", "", "list", "int", "", "", "" ],
					"patching_rect" : [ 330.0, 416.0, 179.0, 22.0 ],
					"save" : [ "#N", "vst~", "loaduniqueid", 0, 9, 1, "dearVR AMBI MICRO", ";" ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_invisible" : 1,
...
,
					"snapshot" : 					{
						...
						"snapshot" : 						{
							...
							"isbank" : 0,
							"isbase64" : 1,
							"blob" : "629.VMjLgvl....OVMEUy..UQAslXuk0UXoWUFE0YQcEV77RRC8Vav8lak4Fc9vyKVMEUy.Ea0cVZtMEcgQWY9.."
						}
,
						"snapshotlist" : 						{
							"current_snapshot" : 0,
...
,
					"text" : "vst~ 9 1 \"dearVR AMBI MICRO\"",
					"varname" : "vst~[1]",
					"viewvisibility" : 0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 332.0, 285.0, 171.0, 22.0 ],
					"saved_object_attributes" : 					{
						"active" : [ 1 ],
						"center_att_db" : 6.0,
						"center_curve" : 0.2,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 130.0, 492.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 357.0, 539.0, 89.0, 22.0 ],
					"text" : "selector~ 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 237.0, 539.0, 89.0, 22.0 ],
					"text" : "selector~ 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 237.0, 581.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal", "", "list", "int", "", "", "" ],
					"patching_rect" : [ 130.0, 416.0, 179.0, 22.0 ],
					"save" : [ "#N", "vst~", "loaduniqueid", 0, 4, 1, "dearVR AMBI MICRO", ";" ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_invisible" : 1,
...
,
					"text" : "vst~ 4 1 \"dearVR AMBI MICRO\"",
					"varname" : "vst~",
					"viewvisibility" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 815.0, 472.0, 135.0, 47.0 ],
					"text" : "y ... left right\nz ... top bottom\nx ... front back"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 146.333333333333343, 166.0, 44.0, 22.0 ],
					"text" : "noise~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 130.0, 285.0, 179.0, 22.0 ],
					"saved_object_attributes" : 					{
						"active" : [ 1 ],
						"center_att_db" : 6.0,
						"center_curve" : 0.2,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 773.5, 29.0, 200.0, 400.0 ]
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 783.0, 435.0, 754.75, 435.0, 754.75, 274.0, 539.5, 274.0 ],
					"order" : 0,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 783.0, 435.0, 754.75, 435.0, 754.75, 274.0, 341.5, 274.0 ],
					"order" : 1,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 783.0, 436.0, 753.25, 436.0, 753.25, 272.0, 139.5, 272.0 ],
					"order" : 2,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 600.5, 214.0, 701.75, 214.0, 701.75, 18.0, 783.0, 18.0 ],
					"source" : [ "obj-19", 0 ]
				}
