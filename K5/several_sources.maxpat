...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 335.0, 303.0, 150.0, 47.0 ],
					"text" : "second argument = number of sources = number of inlets"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 294.0, 33.0, 92.0, 24.0 ],
					"text" : "auto rotate"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 396.0, 33.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 396.0, 70.0, 56.0, 22.0 ],
					"text" : "metro 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 396.0, 99.0, 72.0, 22.0 ],
					"text" : "counter 360"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 396.0, 135.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 396.0, 169.0, 82.0, 22.0 ],
					"text" : "aed 1 $1 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 128.0, 432.0, 185.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 130.0, 301.0, 176.5, 22.0 ],
					"saved_object_attributes" : 					{
						"active" : [ 1, 1, 1 ],
						"center_att_db" : 6.0,
						"center_curve" : 0.2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 518.0, 45.0, 45.0 ]
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 783.0, 435.0, 754.75, 435.0, 754.75, 274.0, 139.5, 274.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 405.5, 214.0, 701.75, 214.0, 701.75, 18.0, 783.0, 18.0 ],
					"source" : [ "obj-19", 0 ]
				}
