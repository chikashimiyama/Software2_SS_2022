...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 448.0, 483.0, 80.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 354.0, 320.0, 44.0, 22.0 ],
					"text" : "noise~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 587.0, 325.0, 203.0, 22.0 ],
					"text" : "aed 1 -130.526293 0. 0.111213 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 827.0, 93.818263360559058, 174.0, 174.0 ],
					"zoom_scale" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 481.0, 519.0, 190.0, 22.0 ],
					"save" : [ "#N", "vst~", "loaduniqueid", 0, 4, 2, "dearVR AMBI MICRO", ";" ],
...
,
					"text" : "vst~ 4 2 \"dearVR AMBI MICRO\"",
					"varname" : "vst~",
					"viewvisibility" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 481.0, 559.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 481.0, 445.0, 190.0, 22.0 ],
					"saved_object_attributes" : 					{
						"active" : [ 1 ],
						"center_att_db" : 6.0,
						"center_curve" : 0.63,
						"center_size" : 1.003367003367003,
						"db_unit" : 1.5,
						"dist_att" : 1.790000000000028,
						"distance_mode" : 2,
						"exp_curve" : 1.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 96.0, 294.0, 66.0, 24.0 ],
					"text" : "y value"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 84.0, 46.0, 66.0, 24.0 ],
					"text" : "x value"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 169.0, 295.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 169.0, 46.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 367.0, 31.0, 150.0, 52.0 ],
					"text" : "jsui with icst.distance_encoding.js"
				}

			}
, 			{
				"box" : 				{
					"embedstate" : [ [ "savedState", 1, 2, 9.379999999999949, 1.790000000000028, 1.003367003367003, 0.63, 56.980000000000004, 17.000999999999998, 1.600000000000001, 0, 4.107744107744108, 36 ] ],
					...
					"outlettype" : [ "", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 169.0, 93.818263360559058, 639.0, 184.0 ],
					"varname" : "dist_edit"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 836.5, 384.0, 490.5, 384.0 ],
					"order" : 1,
					"source" : [ "obj-13", 0 ]
				}
