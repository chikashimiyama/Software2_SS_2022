...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 195.0, 360.5, 150.0, 37.0 ],
					"text" : "very useful object for HOA"
				}
...
,
					...
					"patching_rect" : [ 372.0, 446.0, 198.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 1,
						"parameter_mappable" : 0
					}
,
					"text" : "mc.vst~ 4 2 \"dearVR AMBI MICRO\"",
					"viewvisibility" : 0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 372.0, 409.0, 198.0, 22.0 ],
					"text" : "mc.unpack~ 4"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 372.0, 368.0, 272.0, 22.0 ],
					"text" : "mc.+~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 372.0, 333.0, 120.0, 22.0 ],
					"saved_object_attributes" : 					{
						"active" : [ 1 ],
						"center_att_db" : 6.0,
						"center_curve" : 0.2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 372.0, 482.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.0, 225.0, 150.0, 20.0 ],
					"text" : "mono file"
				}
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 177.0, 253.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 625.0, 273.5, 150.0, 33.0 ],
					"text" : "ambisonic FOA \n4 channel file"
				}
...
, 			{
				"box" : 				{
					...
					"data" : 					{
						"clips" : [ 							{
								"absolutepath" : "Macintosh HD:/Users/chikashi/Downloads/birds.wav",
								"filename" : "birds.wav",
								"filekind" : "audiofile",
								"id" : "u925002037",
								"loop" : 0,
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 625.0, 320.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 372.0, 48.0, 200.0, 200.0 ]
				}
...
, 			{
				"name" : "piano.wav",
				"bootpath" : "~/Works/Event/2022/Software2/K5",
				"patcherrelativepath" : ".",
				"type" : "WAVE",
				"implicit" : 1
			}
