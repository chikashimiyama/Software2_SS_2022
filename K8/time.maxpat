...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 182.0, 25.0, 39.0, 22.0 ],
					"text" : "r stop"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 356.0, 41.0, 22.0 ],
					"text" : "s stop"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 72.0, 423.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 182.0, 391.0, 81.0, 22.0 ],
					"text" : "snapshot~ 30"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 74.0, 131.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 150.666666666666686, 316.0, 45.0, 22.0 ],
					"text" : "curve~"
				}
...
, 			{
				"box" : 				{
					"addpoints_with_curve" : [ 0.0, -1.0, 0, 0.0, 3000.0, 0.942857142857143, 0, -0.545 ],
					"domain" : 3000.0,
					"id" : "obj-2",
					"maxclass" : "function",
					"mode" : 1,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 74.0, 163.0, 249.0, 130.0 ],
					"range" : [ -1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 68.5, 457.0, 246.0, 22.0 ],
					"text" : "pack xyz 1 0. 1. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 572.950000000000045, 351.5, 29.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 640.700000000000045, 299.0, 34.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 711.700000000000045, 225.0, 41.0, 22.0 ],
					"text" : "del 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 711.700000000000045, 261.0, 64.0, 22.0 ],
					"text" : "pack 0. 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 639.700000000000045, 261.0, 64.0, 22.0 ],
					"text" : "pack 1. 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 572.950000000000045, 316.0, 40.0, 22.0 ],
					"text" : "*~ 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 639.700000000000045, 180.0, 56.0, 22.0 ],
					"text" : "metro 80"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 572.950000000000045, 263.0, 44.0, 22.0 ],
					"text" : "noise~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 179.5, 59.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 363.5, 414.0, 187.285714285714334, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 363.5, 143.0, 200.0, 200.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 365.785714285714334, 447.5, 185.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 363.5, 490.0, 45.0, 45.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 189.0, 89.5, 649.200000000000045, 89.5 ],
					"order" : 0,
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 78.0, 500.0, 349.25, 500.0, 349.25, 132.0, 373.0, 132.0 ],
					"source" : [ "obj-8", 0 ]
				}
