...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 461.699999999999989, 13.0, 66.999999999999943, 39.0 ],
					"text" : "across",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 353.699999999999989, 13.0, 66.999999999999943, 39.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.700000000000045, 13.0, 59.0, 39.0 ],
					"text" : "foward",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 154.0, 102.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 47.25, 451.0, 29.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 115.0, 272.0, 34.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 187.0, 183.0, 41.0, 22.0 ],
					"text" : "del 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 187.0, 219.0, 64.0, 22.0 ],
					"text" : "pack 0. 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 115.0, 219.0, 64.0, 22.0 ],
					"text" : "pack 1. 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 47.25, 289.0, 40.0, 22.0 ],
					"text" : "*~ 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 115.0, 138.0, 56.0, 22.0 ],
					"text" : "metro 80"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 47.25, 236.0, 44.0, 22.0 ],
					"text" : "noise~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 353.699999999999989, 54.0, 63.0, 22.0 ],
					"text" : "3, -3 3000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 275.699999999999989, 54.0, 63.0, 22.0 ],
					"text" : "-3, 3 3000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 276.699999999999989, 183.0, 57.0, 22.0 ],
					"text" : "line 0. 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 276.699999999999989, 235.0, 80.0, 22.0 ],
					"text" : "xyz 1 0. $1 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 504.699999999999989, 54.0, 63.0, 22.0 ],
					"text" : "3, -3 3000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 426.699999999999989, 54.0, 63.0, 22.0 ],
					"text" : "-3, 3 3000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 427.699999999999989, 183.0, 57.0, 22.0 ],
					"text" : "line 0. 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 427.699999999999989, 235.0, 80.0, 22.0 ],
					"text" : "xyz 1 $1 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 276.285714285714278, 544.5, 185.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 275.699999999999989, 503.0, 176.5, 22.0 ],
					"saved_object_attributes" : 					{
						"active" : [ 1 ],
						"center_att_db" : 6.0,
						"center_curve" : 0.2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 274.0, 587.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 494.0, 532.0, 135.0, 47.0 ],
					"text" : "y ... left right\nz ... top bottom\nx ... front back"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 275.699999999999989, 289.0, 200.0, 200.0 ],
					"zoom_scale" : 0.375
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 324.199999999999989, 215.0, 246.349999999999994, 215.0, 246.349999999999994, 91.0, 124.5, 91.0 ],
					"source" : [ "obj-13", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"midpoints" : [ 475.199999999999989, 215.0, 245.850000000000023, 215.0, 245.850000000000023, 91.0, 124.5, 91.0 ],
					"source" : [ "obj-2", 1 ]
				}
