...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 24.0, 280.0, 61.0, 24.0 ],
					"text" : "in-out"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 24.0, 252.0, 61.0, 24.0 ],
					"text" : "out-in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 94.0, 280.0, 99.0, 22.0 ],
					"text" : "2, 0 3000 2 3000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 94.0, 252.0, 99.0, 22.0 ],
					"presentation_linecount" : 2,
					"text" : "0, 2 3000 0 3000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 24.0, 207.0, 61.0, 24.0 ],
					"text" : "inward"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 24.0, 164.0, 68.0, 24.0 ],
					"text" : "outward"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 94.0, 200.0, 65.0, 22.0 ],
					"text" : "2, 0 10000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 94.0, 164.0, 65.0, 22.0 ],
					"text" : "0, 2 10000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 260.0, 233.0, 57.0, 22.0 ],
					"text" : "line 0. 30"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 573.950000000000045, 315.5, 29.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 641.700000000000045, 263.0, 34.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 712.700000000000045, 189.0, 41.0, 22.0 ],
					"text" : "del 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 712.700000000000045, 225.0, 64.0, 22.0 ],
					"text" : "pack 0. 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 640.700000000000045, 225.0, 64.0, 22.0 ],
					"text" : "pack 1. 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 573.950000000000045, 280.0, 40.0, 22.0 ],
					"text" : "*~ 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 640.700000000000045, 144.0, 56.0, 22.0 ],
					"text" : "metro 80"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 573.950000000000045, 227.0, 44.0, 22.0 ],
					"text" : "noise~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 172.0, 93.0, 32.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 172.0, 126.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 173.5, 312.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 214.0, 126.0, 72.0, 22.0 ],
					"text" : "counter 360"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 172.0, 12.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 172.0, 64.0, 49.0, 22.0 ],
					"text" : "metro 5"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 364.5, 355.0, 187.285714285714334, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 364.5, 107.0, 200.0, 200.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 366.785714285714334, 388.5, 185.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 364.5, 431.0, 45.0, 45.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 183.0, 355.0, 317.0, 355.0, 317.0, 82.0, 374.0, 82.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 181.5, 53.5, 650.200000000000045, 53.5 ],
					"order" : 0,
					"source" : [ "obj-3", 0 ]
				}
