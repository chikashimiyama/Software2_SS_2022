...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 259.0, 284.0, 77.0, 22.0 ],
					"text" : "pack 0. 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 174.0, 285.0, 77.0, 22.0 ],
					"text" : "pack 0. 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 259.0, 326.0, 57.0, 22.0 ],
					"text" : "line 0. 30"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 174.0, 326.0, 57.0, 22.0 ],
					"text" : "line 0. 30"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 259.0, 234.0, 39.0, 22.0 ],
					"text" : "/ 100."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 174.0, 235.0, 39.0, 22.0 ],
					"text" : "/ 100."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 259.0, 190.0, 36.0, 22.0 ],
					"text" : "- 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 259.0, 148.0, 73.0, 22.0 ],
					"text" : "random 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 174.0, 191.0, 36.0, 22.0 ],
					"text" : "- 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 174.0, 149.0, 73.0, 22.0 ],
					"text" : "random 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.333333333333343, 394.0, 306.333333333333258, 22.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 39.833333333333343, 441.0, 350.25, 441.0, 350.25, 96.0, 374.0, 96.0 ],
					"source" : [ "obj-8", 0 ]
				}
