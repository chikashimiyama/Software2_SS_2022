...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 349.5, 49.0, 150.0, 52.0 ],
					"text" : "move back and forth between two points"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 172.0, 274.0, 87.0, 22.0 ],
					"text" : "xyz 1 $1 0.5 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 533.950000000000045, 311.5, 29.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 601.700000000000045, 259.0, 34.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 672.700000000000045, 185.0, 41.0, 22.0 ],
					"text" : "del 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 672.700000000000045, 221.0, 64.0, 22.0 ],
					"text" : "pack 0. 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 600.700000000000045, 221.0, 64.0, 22.0 ],
					"text" : "pack 1. 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 533.950000000000045, 276.0, 40.0, 22.0 ],
					"text" : "*~ 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 600.700000000000045, 140.0, 56.0, 22.0 ],
					"text" : "metro 80"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 533.950000000000045, 223.0, 44.0, 22.0 ],
					"text" : "noise~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 172.0, 227.0, 24.0, 22.0 ],
					"text" : "sin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 172.0, 191.0, 67.0, 22.0 ],
					"text" : "* 3.141592"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 172.0, 162.0, 39.0, 22.0 ],
					"text" : "/ 180."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 172.0, 126.0, 72.0, 22.0 ],
					"text" : "counter 360"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 324.5, 351.0, 187.285714285714334, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 324.5, 103.0, 200.0, 200.0 ],
					"zoom_scale" : 0.856858533204315
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 326.785714285714334, 384.5, 185.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 324.5, 427.0, 45.0, 45.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 181.5, 41.5, 610.200000000000045, 41.5 ],
					"order" : 0,
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 181.5, 306.0, 277.75, 306.0, 277.75, 96.0, 334.0, 96.0 ],
					"source" : [ "obj-7", 0 ]
				}
